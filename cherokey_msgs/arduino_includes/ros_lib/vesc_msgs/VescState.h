...
namespace vesc_msgs
{
  ...
  class VescState : public ros::Msg
  {
    public:
      ...
      enum { CONNECTION_STATE_DISCONNECTED = 0 };
      enum { CONNECTION_STATE_WAITING_FOR_FW = 1 };
      enum { CONNECTION_STATE_CONNECTED_INCOMPATIBLE_FW = 2 };
      enum { CONNECTION_STATE_CONNECTED = 3 };
    ...
    virtual const char * getType() override { return "vesc_msgs/VescState"; };
    virtual const char * getMD5() override { return "c1869a47b5aaf1f94a1cfeab925c272e"; };
