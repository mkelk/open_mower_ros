...
static const char GETGRIDMAP[] = "grid_map_msgs/GetGridMap";
  ...
  class GetGridMapRequest : public ros::Msg
  {
    ...
    GetGridMapRequest():
      ...
      length_x(0),
      length_y(0),
      layers_length(0), st_layers(), layers(nullptr)
    {
    }
    ...
    virtual const char * getType() override { return GETGRIDMAP; };
    virtual const char * getMD5() override { return "b6b21ecd617fdfa7f32e8c349cec3c2e"; };
  ...
  class GetGridMapResponse : public ros::Msg
  {
    ...
    virtual const char * getType() override { return GETGRIDMAP; };
    virtual const char * getMD5() override { return "4f8e24cfd42bc1470fe765b7516ff7e5"; };
