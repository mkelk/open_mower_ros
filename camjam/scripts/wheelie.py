...
class Node():
    ...
    def create_subscription(self, msg_type, topic, callback, queue_length):
...
class Wheelie (Node):
    ...
    def _joy_callback(self, msg):
        ...
        rospy.loginfo("Joy call-back")

        #rospy.loginfo(f"msg.axes[0] {msg.axes[0]}")
        #rospy.loginfo(f"msg.buttons[5] {msg.buttons[5]}")
...
if __name__ == '__main__':
    rospy.loginfo("wheelie is starting")

    wheelie = Wheelie('wheelie', pinRightFwd=10, pinRightRev=9,
    ...
    rospy.loginfo("wheelie is ending")
